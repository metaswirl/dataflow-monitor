...
import berlin.bbdc.inet.mera.monitor.topology.{TopologyServer,FlinkHttpClient}
...
object Starter extends App {
  ...
  val topoServer = new TopologyServer(flinkHost, flinkPort, new FlinkHttpClient(flinkHost, flinkPort))
